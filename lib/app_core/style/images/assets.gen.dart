...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/arrow_chart.png
  AssetGenImage get arrowChart =>
      const AssetGenImage('assets/images/arrow_chart.png');
  ...
  /// File path: assets/images/face_id.png
  ...
  /// File path: assets/images/trend.png
  AssetGenImage get trend => const AssetGenImage('assets/images/trend.png');
...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/server_error.json
  LottieGenImage get serverError =>
      const LottieGenImage('assets/lottie/server_error.json');

  /// List of all assets
  List<LottieGenImage> get values => [empty, serverError];
}

class $AssetsSvgGen {
  const $AssetsSvgGen();

  /// File path: assets/svg/unlock.svg
  SvgGenImage get unlock => const SvgGenImage('assets/svg/unlock.svg');

  /// List of all assets
  List<SvgGenImage> get values => [unlock];
}
